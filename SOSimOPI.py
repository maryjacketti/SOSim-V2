...
#__________________________________________________________________________________________________________________________
    ...
    def Getinformation(self):
        ...
        if self.DefaultParameterButton.isChecked():
            if self.submerged.isChecked():
                self.ourinformation['vxmin'] = -10.0
                self.ourinformation['vxmax'] = 10.0
                self.ourinformation['vymin'] = -10.0
                self.ourinformation['vymax'] = 10.0
                self.ourinformation['dxmin'] = 0.01
                self.ourinformation['dxmax'] = 2.1 
                self.ourinformation['dymin'] = 0.01
                self.ourinformation['dymax'] = 2.1 
            if self.sunken.isChecked():
            	if self.RiverSpill.isChecked():
                    self.ourinformation['vxmin'] = -67.1
                    self.ourinformation['vxmax'] = 67.1
                    self.ourinformation['vymin'] = -2.4
                    self.ourinformation['vymax'] = 2.4
                    self.ourinformation['dxmin'] = 0.01#0.00001#0.01#0.00001
                    self.ourinformation['dxmax'] = 0.6#0.0001#0.2#0.0001 
                    self.ourinformation['dymin'] = 0.01
                    self.ourinformation['dymax'] = 0.2  
            	if self.OceanSpill.isChecked():
            		self.ourinformation['vxmin'] = -4.0
            		self.ourinformation['vxmax'] = 4.0
            		self.ourinformation['vymin'] = -4.0
            		self.ourinformation['vymax'] = 4.0
            		self.ourinformation['dxmin'] = 0.01
            		self.ourinformation['dxmax'] = 1.1 
            		self.ourinformation['dymin'] = 0.01
            		self.ourinformation['dymax'] = 1.1 
...
#__________________________________________________________________________________________________________________________
    ...
    def on_DefaultParameterButton_clicked(self):
        ...
        if areaselection == QMessageBox.Yes:
	        ...
	        if self.sunken.isChecked():
	        	if self.RiverSpill.isChecked():
	        		self.ourinformation['vxmin'] = -67.1#-2.4
	        		self.ourinformation['vxmax'] = 67.1#2.4
	        		self.ourinformation['vymin'] = -2.4
	        		self.ourinformation['vymax'] = 2.4
	        		self.ourinformation['dxmin'] = 0.01
	        		self.ourinformation['dxmax'] = 0.6
	        		self.ourinformation['dymin'] = 0.01
	        		self.ourinformation['dymax'] = 0.2 
	        	if self.OceanSpill.isChecked():
	        		self.ourinformation['vxmin'] = -4.0
